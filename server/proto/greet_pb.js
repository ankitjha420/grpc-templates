...
proto.greet.GreetManyTimesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    greetmanytimes: (f = msg.getGreetmanytimes()) && proto.greet.Greeting.toObject(includeInstance, f)
  };
...
/**
 * optional Greeting greetManyTimes = 1;
 * @return {?proto.greet.Greeting}
 */
proto.greet.GreetManyTimesRequest.prototype.getGreetmanytimes = function() {
  return /** @type{?proto.greet.Greeting} */ (
    jspb.Message.getWrapperField(this, proto.greet.Greeting, 1));
};
...
*/
proto.greet.GreetManyTimesRequest.prototype.setGreetmanytimes = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.greet.GreetManyTimesRequest} returns this
 */
proto.greet.GreetManyTimesRequest.prototype.clearGreetmanytimes = function() {
  return this.setGreetmanytimes(undefined);
};
 ...
 * @return {boolean}
 */
proto.greet.GreetManyTimesRequest.prototype.hasGreetmanytimes = function() {
  return jspb.Message.getField(this, 1) != null;
};
